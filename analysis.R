...
cr <- new |>
  transmute(
    ...
    # competing/mortality death time from raw dates (single source of truth; matches manuscript)
    t_death = as.numeric(as.Date(death_date) - as.Date(cre_infection_date)),
